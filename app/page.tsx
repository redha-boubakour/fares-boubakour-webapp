            ...
            <div className='h-[100vh] w-full flex flex-col justify-center items-center gap-5'>
                ...
                <div className='max-w-[50%] text-center'>
                    <p>
                        ...
                        busy port or the serenity of a country road, I'm here to
                        share my love for the industry through the lens of my
                        camera. Take a moment to browse through my collection of
                        photos and join me on a visual journey through the world
